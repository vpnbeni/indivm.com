...
export default function JaySolar() {
    ...
    return (
        ...
        <>
            ...
            <div className=" fs-4 py-3 text-center bg-light" style={{  color: '#ca9d10' }}>We are authorised Distributors for most efficient breed of Solar Water Heater by name of <a href='https://www.jaysolar.net/solar-water-heater-tank.html'> <img className='mx-2' src={require('../img/jay-solar-logo.jpg')} alt="JaySolar" target="_blank" /></a></div>
