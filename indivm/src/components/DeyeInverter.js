...
export default function DeyeInverter() {
    ...
    return (
        ...
        <>
            ...
            <div className=" fs-4 py-3 text-center bg-light" style={{  color: '#ca9d10' }}>We are authorised Distributors for most efficient breed of Hybrid Inverters by name of <a href='https://www.deyeinverter.com/product/hybrid-inverter-1/'> <img className='mx-2' src={require('../img/deyeLogo.png')} alt="Autobat" target="_blank" /></a></div>
