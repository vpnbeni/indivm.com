...
export default function LiBattery() {
    AOS.init({
        duration: 1200,
    })
    return (
        ...
        <>
            ...
            <div className='solarPV m-0 p-0 ' >
                <div className='soalrPVHead p-lg-5 px-3  m-0  '>
                    <p className=''  >
                        Autobat Lithium Batteries
                    </p>
                </div>
            </div>
            <div className=" fs-4 py-3 text-center bg-light" style={{  color: '#ca9d10' }}>We are authorised Distributors for most efficient breed of Lithium Batteries by name of <a href='http://autobat51.com/newsite/batteries.html'> <img className='mx-2' src={require('../img/autobatLogo.png')} alt="Autobat" target="_blank" /></a></div>
            <div className='container-fluid py-5 d-flex align-items-center justify-content-center' style={{ backgroundColor: '#004d4c' }} >
                <iframe className='sunbondPVWeb' src="http://autobat51.com/newsite/batteries.html" width={'75%'} height={'600px'} frameborder="0"></iframe>
            </div>
            ...
            <div className="container my-lg-5 my-3">
                <div className=" row m-0 mt-lg-5 p-0" >
                    ...
                    <div className="animateImgBg col-lg-6 col-12 ">
                        <img className='p-2' src={require('../img/li battery.jpg')} data-aos="fade-up" data-aos-offset="150" data-aos-easing="ease-in-sine" data-aos-duration="200" />
