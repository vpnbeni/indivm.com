...
export default function LiBattery() {
    ...
    return (
        ...
        <>
            ...
            <div onLoad={scrollToTop} className=" fs-4 py-3 text-center bg-light" style={{ color: '#ca9d10' }}>We are authorised Distributors for most efficient breed of Lithium Batteries by name of <a href='http://autobat51.com/newsite/batteries.html'> <img className='mx-2' src={require('../img/autobatLogo.png')} alt="Autobat" target="_blank" /></a></div>
