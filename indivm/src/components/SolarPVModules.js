...
export default function SolarPVModules() {
    ...
    return (
        ...
        <>
            ...
            <div onLoad={scrollToTop} className=" fs-4 py-3 text-center" style={{ backgroundColor: '#004d4c', color: '#ca9d10' }}>We are authorised Distributors for most efficient breed of Solar PV modules by name of <a href='https://sunbondenergy.com/manufacturer'> <img className='mx-2' src={require('../img/sunbond.png')} alt="Sunbond" target="_blank" /></a></div>
